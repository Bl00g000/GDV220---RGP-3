...
public class EnemyRat : EnemyBase
{
    ...
    public override void Attack()
    {
        ...
        else
        {
            ...
            //{
                ...
                Vector3 v3DirAvoidLight = GetOutOfLightDirection(2);
    ...
    Vector3 GetOutOfLightDirection(float _length)
    {
        Vector3 awayFromPlayer = ((transform.position - PlayerMovement.instance.transform.position).normalized * _length) + transform.position;
